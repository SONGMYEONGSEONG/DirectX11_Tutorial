...
#include "../D3D_태양계만들기/Components/DXCamera.h" //z/stencil buffer 구현
...
private:
	...
	std::unique_ptr <PrimitiveModel> parentPrimitive;
	std::unique_ptr <PrimitiveModel> Primitive;
	std::unique_ptr <PrimitiveModel> childPrimitive;
	//std::unique_ptr <PrimitiveModel> primitive_test;// 추가 

	DXGameObject parentPrimitiveObj;
	DXGameObject PrimitiveObj;
	DXGameObject childPrimitiveObj;

	DXGameObject Sun_Earth_node;
	DXGameObject Earth_Moon_node;
